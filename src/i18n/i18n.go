...
var tables = map[string]map[string]string{
	English: {
		...
		"stage.telegram.hint":        "This step confirms that you are a real person and that you genuinely own this Telegram account. Authorization is used only for this verification session.",
		"stage.telegram.notice":      "Telegram shares your basic profile — name, username and avatar — and allows the linked bot to send you the private message required for verification. This does not let the bot read your other chats, message as you, or control your account.",
		"stage.telegram.docs.aria":   "Official Telegram authorization documentation",
		"stage.telegram.docs.prefix": "Telegram official documentation:",
		"stage.telegram.docs.login":  "App authorization scopes ↗",
		"stage.telegram.docs.bot":    "Bot message access ↗",
		"stage.telegram.button":      "Authorize with Telegram",
		...
		"terminal.TURNSTILE_ATTEMPTS_EXHAUSTED": "Too many anti-bot attempts were made. Ask the bot for a new verification link.",
		...
		"status.telegram_ready":      "Authorize Telegram access to continue.",
		...
		"error.session_restart":      "This attempt is no longer current. Retry to restart verification with the same link.",
		"error.telegram_unavailable": "Telegram authorization is not available in this browser. Please reopen the verification link in Telegram.",
		"error.telegram_timeout":     "Telegram did not finish authorizing. Please try again.",
		"error.telegram_cancelled":   "Telegram authorization was cancelled. Please try again.",
	...
	Chinese: {
		...
		"stage.telegram.hint":        "此操作用于确认您是真人，并确认该 Telegram 账户确由您本人持有。授权仅用于本次验证会话。",
		"stage.telegram.notice":      "Telegram 会向我们提供您的基本资料——姓名、用户名和头像，并允许关联 Bot 向您发送验证所需的私信。该权限不能读取您的其他聊天、以您的身份发送消息或控制您的账户。",
		"stage.telegram.docs.aria":   "Telegram 官方授权文档",
		"stage.telegram.docs.prefix": "Telegram 官方文档：",
		"stage.telegram.docs.login":  "APP 授权范围 ↗",
		"stage.telegram.docs.bot":    "Bot 消息访问范围 ↗",
		"stage.telegram.button":      "授权 Telegram 访问",
		...
		"terminal.TURNSTILE_ATTEMPTS_EXHAUSTED": "反机器人验证尝试次数已耗尽。请向机器人索取新的验证链接。",
		...
		"status.telegram_ready":      "授权 Telegram 访问以继续。",
		...
		"error.session_restart":      "本次验证状态已失效。可使用当前链接重试并重新开始验证。",
		"error.telegram_unavailable": "当前浏览器无法使用 Telegram 授权。请在 Telegram 中重新打开验证链接。",
		"error.telegram_timeout":     "Telegram 授权未能完成，请重试。",
		"error.telegram_cancelled":   "已取消 Telegram 授权，请重试。",
