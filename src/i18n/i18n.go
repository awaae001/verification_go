...
var tables = map[string]map[string]string{
	English: {
		...
		"stage.telegram.hint":   "Authorize Telegram access so we can link this verification to you. It is used for this session only.",
		"stage.telegram.notice": "Telegram only shares your basic profile — name, username and avatar. Authorizing through the bot cannot read your chats, send messages, or otherwise access or control your account.",
	...
	Chinese: {
		...
		"stage.telegram.hint":   "授权 Telegram 访问，以便将本次验证与您关联。仅用于本次会话。",
		"stage.telegram.notice": "Telegram 仅会向我们提供您的基本资料——姓名、用户名和头像。通过机器人授权无法读取聊天记录、发送消息，或以任何方式访问和控制您的账户。",
